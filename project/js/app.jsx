...
const { DEFAULT_MENU, DEFAULT_SETTINGS } = window.SEDRA;
...
function App() {
  ...
  const toast = useCallback((msg) => {
    ...
    clearTimeout(window.__sedraToast);
    window.__sedraToast = setTimeout(() => setToastMsg(null), 1600);
  }, [lang]);
