...
import { STRINGS, TAGS } from '../data/menu.js'

export const t = (obj, lang) => (obj && (obj[lang] ?? obj.en)) || ""
export const fmtPrice = (n) => Number(n || 0).toFixed(2)
export const arDigits = (str) =>
  String(str).replace(/[0-9]/g, (d) => "٠١٢٣٤٥٦٧٨٩"[d])
export const localizeNum = (str, lang) => (lang === "ar" ? arDigits(str) : String(str))

export function fileToThumb(file, max = 460, quality = 0.72) {
...
export const LogoMark = ({ size = 46, logo = null }) => {
  if (logo) {
...
export const Thumb = ({ photo, size = 58 }) => (
