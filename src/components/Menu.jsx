...
import { STRINGS as S } from '../data/menu.js'
import { t, fmtPrice, localizeNum, Icon, LogoMark, Thumb, TagBadge, LangToggle, SearchBar } from './ui.jsx'
...
const CategorySection = ({ cat, lang, currency, refCb }) => (
  <section ref={refCb} data-cat={cat.id} style={{ scrollMarginTop: 118, breakInside: "avoid", marginBottom: 30 }}>
...
export const MenuScreen = ({ menu, settings, lang, setLang, table, onAdmin }) => {
